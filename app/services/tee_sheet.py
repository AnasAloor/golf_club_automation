...
from app.schemas import TeeSheetBookingRequest, TeeSheetBookingResponse, TeeSheetResponse
...
class TeeSheetAutomation(Protocol):
    ...
    def book_tee_time(self, booking: TeeSheetBookingRequest) -> TeeSheetBookingResponse:
        """Reserve a tee time in the desktop application."""
...
async def book_tee_time(
    ...
    async with _automation_lock:
        return await asyncio.to_thread(
            selected_automation.book_tee_time,
            booking,
        )
